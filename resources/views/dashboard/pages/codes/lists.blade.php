                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{$code->informations->first()->cityName,
                                    $code->informations->first()->countryName}} </td>
                                ...
                                <td>
                                    <label
                                        class="badge {{ ($code->scanned < 1) ? 'badge-gradient-primary' : ($code->scanned == 1 ? 'badge-gradient-success' : 'badge-gradient-danger') }}">{{
                                        ($code->scanned < 1) ? 'Not Scanned' : ($code->scanned == 1 ? 'Correct Scanned'
