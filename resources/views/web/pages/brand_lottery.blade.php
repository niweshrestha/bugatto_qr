...
@section('content')
    <div class="container-fluid" id="contact">
        <div class="row no-gutter" style="position: relative;">
            ...
            <!-- The content half -->
            <div class="col-md-12">
                <div class="lottert {{ !$lottery ? 'no-lottert' : '' }} d-flex justify-content-center" style="margin-bottom: 24px;">
                    <!-- Demo content-->
                    <div class="content">
                        <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto" style="margin-top: 50px;">
                                @if (!$lottery)
                                ...
                                @else
                                    ...
                                    <div class="lottery-box">
                                        ...
                                        @if ($lotteryEnds == true)
                                            <div style="display: flex; justify-content: center; margin-top: 20px;">Lottery ends in:</div>
                                            ...
                                            <div class="lottery-cover">
                                                <img src="{{ asset('storage/uploads/' . $lottery->file) }}"
                                                    alt="lottery-cover">
                                            </div>
                                            ...
                                            <div class="lottery-form shadow-sm">
                                                ...
                                                <form
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-dark text-uppercase mb-2 shadow-sm py-3"
                                                        style="width: 100%;">
                                                        Join Lottery
                                                    </button>
                                                </form>
                                        ...
                                        @if ($lotteryEnds == false)
                                            <div class="lottery-form">
                                                <h3 class="form-title-2">Lottery Completed! registration are closed now.
                                                </h3>
                                            </div>
                                        @endif
                                    </div>
